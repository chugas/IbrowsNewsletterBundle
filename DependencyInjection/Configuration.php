              ...
              ->children()
                ->arrayNode('model')
                  ...
                  ->children()
                    ...
                    ->scalarNode('newsletterSubscriber')->isRequired()->cannotBeEmpty()->end()            
                  ->end()
                ->end()
                ->arrayNode('form')
                  ->addDefaultsIfNotSet()
                  ->children()
                    ...
                    ->scalarNode('newslettersettings')->defaultValue('Ibrows\\Bundle\\NewsletterBundle\\Form\\NewsletterSettingsType')->end()
                  ->end()
                ->end()
              ->end()
            ->end()
